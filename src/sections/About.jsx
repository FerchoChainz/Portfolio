...
export const About = () => {
  return (
    <section id="about" className="relative z-10 bg-black pt-20 pb-24 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
                <p>
                  I am a passionate software developer with a strong background in building and improving applications. With a focus on clean code, performance, collaboration, and innovation, I strive to create impactful solutions that solve real-world problems.
                </p>
                <p>
